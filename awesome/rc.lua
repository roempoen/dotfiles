...
-- starbreaker drafts
withoutbloodshed = gui_editor .. "~/Documents/starbreaker/part1-withoutbloodshed"
blackenedphoenix = gui_editor .. "~/Documents/starbreaker/part2-theblackenedphoenix"
silentclarion = gui_editor .. " ~/Documents/starbreaker/silentclarion"

-- jekyll projects
matthewgraybosch_com = gui_editor .. "~/github/jekyll-matthewgraybosch"
starbreakerseries_com = gui_editor .. "~/github/jekyll-starbreaker"
...
awful.rules.rules = {
    ...
    { rule = { name = "silentclarion" },
        properties = { tag = tags[1][2] } },

    { rule = { name = "part1-withoutbloodshed" },
        properties = { tag = tags[1][2] } },

    { rule = { name = "part2-theblackenedphoenix" },
        properties = { tag = tags[1][2] } },
